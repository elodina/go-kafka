...
func consumerGroupsSinglePartitionRoutine(t *testing.T, quit chan int) {
	...
	consumer2 := consumer.NewKafkaConsumerGroup(singlePartitionsTopic, consumerGroup1, zookeepers, nil)
	...
	consumer3 := consumer.NewKafkaConsumerGroup(singlePartitionsTopic, consumerGroup1, zookeepers, nil)
...
func consumerGroupsMultiplePartitionsRoutine(t *testing.T, quit chan int) {
	...
	fmt.Println("consume these messages with a consumer group")
	consumer1 := consumer.NewKafkaConsumerGroup(multiplePartitionsTopic, "group1", zookeepers, nil)
